...
<div class="imgAndInfo">
    ...
    <div class="imgInimgAndInfo">
        <img src="img/productSingle/${p.fisrtproductImage.id}.jpg" class="bigImg">
    ...
    <div class="infoInimgAndInfo">
        ...
        <div class="productPrice">
            <div class="juhuasuan">
                <span class="juhuasuanBig" >小米自营店</span>
                <span>此商品即将参加秒杀，<span class="juhuasuanTime">1天1小时</span>后开始，</span>
            </div>
            <div class="productPriceDiv">
                <div class="gouwujuanDiv"><img height="16px" src="img/site/gouwujuan.png">
                    <span> 赠Redmi AirDots S 真无线蓝牙耳机 黑色</span>
                ...
                <div class="promotionDiv">
                    ...
                    <span class="promotionPriceYuan">元</span>
                </div>
            </div>
        </div>
